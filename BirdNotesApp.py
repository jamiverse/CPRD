...
#------------------------CODE CENY ---------------------------------------------------------
        ...
        self.changeparam_button = customtkinter.CTkButton(self.sidebar_frame, text = "Change Parameters", command=self.main_parameters)
        self.changeparam_button.grid(row=4, column=0, padx=(20, 20), pady=(10, 10), sticky="ew" )
      # LES 2 LIGNES JUSTE AU DESSUS REMPLACE LE BOUTON SPLIT SILENCE, JE NE SAIS PAS OU PLACER LE BOUTON QUE J'AI CREE
